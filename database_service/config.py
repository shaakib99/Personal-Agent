...
from database_service.jobs_search_service import JobsSearchService

AllowedCollections = Literal['user', 'preference', 'interest', 'conversation', 'job_search'] #'preferences', 'products']
